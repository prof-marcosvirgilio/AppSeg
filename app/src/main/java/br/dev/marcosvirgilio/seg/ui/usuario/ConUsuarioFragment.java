 ...
 */
public class ConUsuarioFragment extends Fragment implements Response.ErrorListener, Response.Listener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //inicializando a fila de requests
        this.requestQueue = Volley.newRequestQueue(this.view.getContext());
...
//mostrar mensagem que veio do servidor
        Snackbar mensagem = Snackbar.make(view,
                "Ops! Houve um problema ao realizar a consulta: " + error.toString(),
    ...
    public void onResponse(Object response) {
        try {
            ...
            if (jsonArray != null) {
                ...
                //preenchendo ArrayList com dados do JSONArray recebido
           ...
           Mas foi movido para cá, porque só pode ser executado se o this.sensores for válido.
           Ou seja, se NÃO retornar dados da consulta, ele não deve ser executado;
           */
                if (view instanceof RecyclerView) {
                    ...
                    recyclerView.setAdapter(new ConUsuarioRecyclerViewAdapter(this.usuarios));
                }
